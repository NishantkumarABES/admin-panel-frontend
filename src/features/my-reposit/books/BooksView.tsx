...
import { Search, Filter, Plus, BookOpen, ShoppingCart } from "lucide-react";
        ...
        <div className="space-y-6 min-w-0 max-w-full">
            ...
            <div className="flex items-center gap-1 bg-gray-100 rounded-lg p-1 w-fit">
                <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-md transition-colors ${activeTab === "books"
                ...
                <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-md transition-colors ${activeTab === "purchases"
                            ? "bg-white text-gray-900 shadow-sm"
                            : "text-gray-600 hover:text-gray-900"
                        }`}
                >

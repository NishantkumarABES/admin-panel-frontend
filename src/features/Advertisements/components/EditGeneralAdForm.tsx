...
export default function EditGeneralAdForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (detail && typeof detail === "string") {
        ...
        setErrors({
          submit: "Failed to update advertisement. Please try again.",
        });
      }
    } finally {
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={handleClose}
      title="Edit General Advertisement"
      size="md"
    >
      <div className="flex flex-col h-full">
        ...
        {submitSuccess ? (
          ...
          <form id="edit-ad-form" onSubmit={handleSubmit} className="flex flex-col h-full">
            <div className="flex-1 overflow-y-auto pr-2 space-y-5 custom-scrollbar" style={{
              ...
              <div className="rounded-xl px-5 py-4" style={sectionStyle}>
                ...
                <p className="text-xs text-gray-500 mb-3">
                  Supported formats: {allowedExtensions.join(", ").toUpperCase()} | Max size: 2MB (Leave empty to keep current image)
                </p>

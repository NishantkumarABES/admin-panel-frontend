...
import type { SoCoupon, CreateSoCouponDTO, UpdateSoCouponDTO } from "../so_coupon.types";
import Modal from "../../../../components/common/Modal";

interface AddEditSoCouponModalProps {
    coupon?: SoCoupon | null;
    isOpen: boolean;
    onClose: () => void;
    onSubmit: (data: CreateSoCouponDTO | UpdateSoCouponDTO) => Promise<{ error?: string }>;
}

const initialFormData: CreateSoCouponDTO = {
    code: "",
    description: "",
...
export default function AddEditSoCouponModal({ coupon, isOpen, onClose, onSubmit }: AddEditSoCouponModalProps) {
    const isEditMode = !!coupon;

    const [formData, setFormData] = useState<CreateSoCouponDTO | UpdateSoCouponDTO>(initialFormData);
                            ...
                            <div className="rounded-xl px-5 py-4" style={{
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        rows={2}
                                    />
                                    <p className={`mt-1.5 text-xs text-right ${(formData.description?.length || 0) >= 500 ? "text-red-500" : "text-gray-400"}`}>
                            ...
                            <div className="rounded-xl px-5 py-4" style={{
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400 mt-1.5">
                                        {formData.is_active
                                            ? "This coupon is active and can be used for second opinions."

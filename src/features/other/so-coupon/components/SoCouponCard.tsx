...
interface SoCouponCardProps {
    coupon: SoCoupon;
    onView: (coupon: SoCoupon) => void;
    onEdit: (coupon: SoCoupon) => void;
    onDelete: (coupon: SoCoupon) => void;
    onToggleStatus: (coupon: SoCoupon) => void;
    isExpired?: boolean;
}

export default function SoCouponCard({
    coupon,
    onView,
    onEdit,
    onDelete,
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    <span
                        ...
                        style={{
                            ...
                            color: isPercentage ? "#0d9488" : "#0284c7",
                        }}
                    >
